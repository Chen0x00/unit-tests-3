...
public class OrderTransactionMQListener_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.nbcb.mq.OrderTransactionMQListener"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.nbcb.entity.Result", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.nbcb.mapper.ShopUserMapper", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.nbcb.mapper.ShopUserMoneyLogMapper", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.nbcb.pojo.ShopUser", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.nbcb.pojo.ShopUserMoneyLog", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.apache.rocketmq.client.producer.DefaultMQProducer", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.apache.rocketmq.common.message.MessageExt", false, OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OrderTransactionMQListener_SSTest_scaffolding.class.getClassLoader()); 
