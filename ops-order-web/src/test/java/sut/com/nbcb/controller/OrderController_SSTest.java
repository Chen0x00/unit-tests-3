...
// allCoveredLines:[19, 33, 34, 35, 37, 38, 39, 40, 41, 42, 50, 51, 52, 53, 54, 55, 56, 57, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 71, 73, 75, 77, 78, 79, 80, 81, 83, 84, 85, 86, 88, 89, 97, 99, 101, 103, 104, 105, 107]
  ...
  public void test_confirmOrder_0()  throws Throwable  {
      //caseID:cb62c6839849eb946d12c0d56c07554a
      //CoveredLines: [19, 50, 51, 52, 53, 54, 55, 56, 57, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 71, 73, 75, 77, 78, 79, 80, 81, 83, 84, 85, 86, 88, 89]
      //Input_0_ShopOrder: {getCouponId=2852L, getShippingFee=BigDecimal.TEN BigDecimal.TEN, getGoodsAmount=BigDecimal.TEN BigDecimal.TEN, getGoodsNumber=0 0, getAddress=\"{\\\"sourceCode\\\":\\\"0\\\",\\\"payAmount\\\":1.0,\\\"orderId\\\":1,\\\"message\\\":\\\"0\\\",\\\"status\\\":false}\", getOrderAmount=BigDecimal.TEN, getGoodsPrice=BigDecimal.TEN BigDecimal.TEN, getUserId=2852L, getGoodsId=2852L 2852L, getMoneyPaid=BigDecimal.TEN}
      ...
      doReturn("{\"sourceCode\":\"0\",\"payAmount\":1.0,\"orderId\":-1,\"message\":\"\u64CD\u4F5C\u6210\u529F\",\"status\":false}", "r").when(result0).getMessage();
      //mock iOrderService0
      ...
      doReturn("{\"sourceCode\":\"0\",\"payAmount\":1.0,\"orderId\":1,\"message\":\"0\",\"status\":false}").when(shopOrder0).getAddress();
  ...
  public void test_confirmOrderPre_1()  throws Throwable  {
      //caseID:ba64ae39f17dee02ce38b55a7efa48ab
  ...
  public void test_getOrder_2()  throws Throwable  {
      //caseID:a86b42af6b495458c860411b7fe8daa0
