...
// allCoveredLines:[26, 40, 43, 44, 45, 54, 57]
  ...
  public void test_doLogin_0()  throws Throwable  {
      //caseID:a00ce026683a200cb416c99d2a24011d
      //CoveredLines: [26, 40, 43, 44, 45, 54, 57]
      //Input_0_UserLogin: {getPassword=\"1\", getAccount=\"1\"}
      ...
      doReturn("1").when(userLogin0).getAccount();
      doReturn("1").when(userLogin0).getPassword();
