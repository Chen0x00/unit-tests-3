...
// allCoveredLines:[26, 40, 43, 44, 45, 54, 57]
  ...
  public void test_doLogin_0()  throws Throwable  {
      //caseID:6e9c970549decfd9616cd0a65f88c3c9
      //CoveredLines: [26, 40, 43, 44, 45, 54, 57]
      //Input_0_UserLogin: {getPassword=\"9RL\", getAccount=\"9RL\"}
      ...
      doReturn("9RL").when(shopUser0).getUserPassword();
      //mock iUserService0
      ...
      doReturn("9RL").when(userLogin0).getAccount();
      doReturn("9RL").when(userLogin0).getPassword();
