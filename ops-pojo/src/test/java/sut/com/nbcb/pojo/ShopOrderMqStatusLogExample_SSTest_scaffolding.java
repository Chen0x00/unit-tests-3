...
public class ShopOrderMqStatusLogExample_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.nbcb.pojo.ShopOrderMqStatusLogExample"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.nbcb.pojo.ShopOrderMqStatusLogExample$Criteria", false, ShopOrderMqStatusLogExample_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(ShopOrderMqStatusLogExample_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ShopOrderMqStatusLogExample_SSTest_scaffolding.class.getClassLoader()); 
